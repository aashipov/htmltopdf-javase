...
docker run -d --name=${CONTAINER_NAME} --hostname=${CONTAINER_NAME} --network=${CONTAINER_NAME} -eLC_ALL=en_US.UTF-8 -e"${JAVA_TOOL_OPTIONS}" ${PORTS_TO_PUBLISH} ${CONTAINER_NAME}
